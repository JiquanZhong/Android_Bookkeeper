            ...
            public void onClick(View view) {
                if (((oldpass_ed.getText().toString()).equals(passDao.find()))) {
                    if ((newpass_ed.getText().toString()).equals(confirmpass_ed.getText().toString())) {
                        ...
                        Toast.makeText(Setting.this, "Modify successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    } else {
                        Toast.makeText(Setting.this, "Two different password input, please enter again!", Toast.LENGTH_SHORT).show();
                        newpass_ed.setText("");
                        confirmpass_ed.setText("");
                    }
                } else {
                    Toast.makeText(Setting.this, "The original password input error, please enter again!", Toast.LENGTH_SHORT).show();
                    oldpass_ed.setText("");
                }
            }
        });
