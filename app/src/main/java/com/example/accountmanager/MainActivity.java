        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (input.equals(affirm) && (!input.equals(""))) {
                    ...
                    passDao.add(passST);
                    Toast.makeText(MainActivity.this, "Set successfully, the new password takes effect!", Toast.LENGTH_SHORT).show();
                    Intent mainintent = new Intent(MainActivity.this, MainPage.class);
                    startActivity(mainintent);
                } else {
                    Toast.makeText(MainActivity.this, "Password input is inconsistent or not entered!", Toast.LENGTH_SHORT).show();
                }
            }
        });
